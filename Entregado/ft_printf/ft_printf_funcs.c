...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/12 04:20:57 by alejmart          #+#    #+#             */
/*   Updated: 2025/10/12 04:20:58 by alejmart         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Prints a string with the format specified.
 */
int	ft_print_str(char *stri, t_format *format)
{
	...
	str = ft_handle_null_str(stri, format);
	len = ft_get_effective_len(str, format);
	if (format->minus == 1)
	{
